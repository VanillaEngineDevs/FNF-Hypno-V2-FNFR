...
function character.boyfriendpixel(x, y)
    ...
    char:addAnimByPrefix("left", "BF LEFT NOTE0", 24, false)
    char:addAnimByPrefix("right", "BF RIGHT NOTE0", 24, false)
    char:addAnimByPrefix("up", "BF UP NOTE0", 24, false)
    char:addAnimByPrefix("down", "BF DOWN NOTE0", 24, false)
